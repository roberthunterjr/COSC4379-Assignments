#############################################################################
# Makefile for building: Assignment1
# Generated by qmake (2.01a) (Qt 4.8.5) on: Thu Jun 8 15:04:27 2017
# Project:  Assignment1.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.8.5/bin/qmake -o Makefile Assignment1.pro
#############################################################################
...
Makefile: Assignment1.pro  /usr/local/Trolltech/Qt-4.8.5/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.8.5/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile Assignment1.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Assignment11.0.0 || $(MKDIR) .tmp/Assignment11.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Assignment11.0.0/ && $(COPY_FILE) --parents myslider.cpp .tmp/Assignment11.0.0/ && (cd `dirname .tmp/Assignment11.0.0` && $(TAR) Assignment11.0.0.tar Assignment11.0.0 && $(COMPRESS) Assignment11.0.0.tar) && $(MOVE) `dirname .tmp/Assignment11.0.0`/Assignment11.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Assignment11.0.0
